...
let lenguajes=["java","javascript","jquery","php","python","c","c++","haskell","angular","react","prolog"]
...
function buscarTexto(lenguaje) {
    ...
    return lenguaje.startsWith(q) //devuelve true si comienza con el texto que ingreso el usuario en q
}
